...
export class ProfileAvatarService {
  ...
  async updateAvatar(
    ...
    throw new CustomHttpException('No file uploaded or file is empty', HttpStatus.BAD_REQUEST);
  }

  // Validate file size
  if (file.size > this.maxSize) {
    throw new CustomHttpException('Image exceeds max allowed size', HttpStatus.BAD_REQUEST);
  }
    // Validate MIME type
